<?php
require_once('./controllers/cookies-controller.php');
$theme = manage_cookies();
        ...
        <section class="md:w-1/4 mx-auto md:mt-20 p-3 bg-gray-300 dark:bg-gray-600 dark:text-gray-50 shadow-lg">
            ...
            <form action="./controllers/login_controller.php" method="post">
                <div class="mb-3">
                    ...
                    <input name="login" class="form-control focus:shadow-outline dark:text-gray-50" type="text">
                </div>
                <div class="mb-3">
                    <label class="form-label dark:text-gray-50" for="password">Mot de passe</label>
                    <input name="password" class="form-control focus:shadow-outline dark:text-gray-50" type="password">
                </div>
                <div class="mb-3">
                    <button class="px-8 py-4 bg-blue-500 hover:bg-blue-600 text-white shadow rounded" type="submit">Se connecter</button>
                </div>
            </form>
        </section>
    </main>
